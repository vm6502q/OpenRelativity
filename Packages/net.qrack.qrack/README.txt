...
You can either delete csc.rsp in the Qrack package root, and remove the dependency on "net.qrack.openrelativity" in package.json, or you can simply install and use the OpenRelativity package alongside the Qrack package.
