...
namespace Qrack
{
...
#endif
    {
        ...
        public void TimeEvolve(double t, Support.TimeEvolveOpHeader[] teos, double[] mtrx)
        {
            Support.TimeEvolveOpHeader[] mappedTeos = new Support.TimeEvolveOpHeader[teos.Length];
